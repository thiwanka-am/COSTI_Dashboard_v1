...
function drawTopInstituteGraph(){
	var svgTopInst = d3.select("#top-inst-1-area")
		.append("svg")
		.attr("width", 400)
		.attr("height", 100)
	...
	var topInstGroup = svgTopInst.append("g")
		.attr("id", "topInstGroup1");
	
	var defs3 = topInstGroup.append("defs");
	
	var grad1 = defs3.append("linearGradient")
		.attr("id", "grad1")
		.attr("x1", "0%")
	    .attr("y1", "0%")
	    .attr("x2", "100%")
	...
	var grad2 = defs3.append("linearGradient")
		.attr("id", "grad2")
		.attr("x1", "0%")
	    .attr("y1", "0%")
	    .attr("x2", "100%")
	...
	var grad3 = defs3.append("linearGradient")
		.attr("id", "grad3")
		.attr("x1", "0%")
	    .attr("y1", "0%")
	    .attr("x2", "100%")
	...
	grad3.append("svg:stop")
	    .attr("offset", "100%")
	    .attr("stop-color", "#dabe4c")
	    .attr("stop-opacity", 1);
		
	topInstGroup.append("rect")
		.attr("x", 0)
		.attr("y", 10)
		.attr("width", 300)
		.attr("height", 20)
	...
	//
	var svgTopInst2 = d3.select("#top-inst-2-area")
		.append("svg")
		.attr("width", 400)
		.attr("height", 50)
		.attr("xmlns", "http://www.w3.org/2000/svg")
	...
	var topInstGroup2 = svgTopInst2.append("g")
		.attr("id", "topInstGroup2");
	
	var defs4 = topInstGroup2.append("defs");
	
	var grad4 = defs4.append("linearGradient")
		.attr("id", "grad4")
		.attr("x1", "0%")
	    .attr("y1", "0%")
	    .attr("x2", "100%")
	    .attr("y2", "0%");
	grad4.append("svg:stop")
		.attr("offset", "0%")
		.attr("stop-color", "#4682B4")
		.attr("stop-opacity", 1);
	grad4.append("svg:stop")
	...
	var grad5 = defs4.append("linearGradient")
		.attr("id", "grad5")
		.attr("x1", "0%")
	    .attr("y1", "0%")
	    .attr("x2", "100%")
	    .attr("y2", "0%");
	grad5.append("svg:stop")
		.attr("offset", "0%")
		.attr("stop-color", "#A52A2A")
		.attr("stop-opacity", 1);
	grad5.append("svg:stop")
	...
	var grad6 = defs4.append("linearGradient")
		.attr("id", "grad6")
		.attr("x1", "0%")
	    .attr("y1", "0%")
	    .attr("x2", "100%")
	    .attr("y2", "0%");
	grad6.append("svg:stop")
		.attr("offset", "0%")
		.attr("stop-color", "#FFCC00")
		.attr("stop-opacity", 1);
	grad6.append("svg:stop")
